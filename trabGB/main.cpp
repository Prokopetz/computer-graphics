...
int main()
{
	...
	Shader coreShader = Shader("./trabGB/shaders/vertex.shader", "./trabGB/shaders/fragment.shader");
	coreShader.Use();
	...
	NewObject *ground = new NewObject("./trabGB/assets/ground/ground.obj");
	...
	NewObject *pikachu = new NewObject("./trabGB/assets/pokemon/Pikachu.obj");
	pikachu->setHasCollision(true);
	objects.push_back(pikachu);
	NewObject *pikachu1 = new NewObject("./trabGB/assets/pokemon/Pikachu.obj");
	pikachu1->setHasCollision(true);
	pikachu1->setTranslate(glm::vec3(-10.0f, 0.0f, -10.0f));
	objects.push_back(pikachu1);
	NewObject *pikachu2 = new NewObject("./trabGB/assets/pokemon/Pikachu.obj");
	pikachu2->setHasCollision(true);
	pikachu2->setTranslate(glm::vec3(-5.0f, 0.0f, 3.0f));
	objects.push_back(pikachu2);
	NewObject *pikachu3 = new NewObject("./trabGB/assets/pokemon/Pikachu.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_PRESS)
		{
			...
			if (now - lastTime >= 0.5)
			{
				NewObject *bullet = new NewObject("./trabGB/assets/cube/cube.obj");
